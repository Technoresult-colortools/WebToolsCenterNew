        ...
        <div className="relative w-full pt-16 pb-8">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
              ...
              <div className="lg:col-span-1 space-y-6">
                <div>
                  ...
                  <p className="mt-4 text-default-500 max-w-md">
                ...
                <nav className="flex flex-col gap-2">
                  {categories.map((category) => (
                    <Link
                      ...
                      color="foreground"
                      className="w-fit hover:text-primary flex items-center gap-2"
                    >
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <Button
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group bg-[#FFDD00] hover:bg-[#FFDD00]/90 text-black font-semibold py-2 px-4 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
                  >
                    <div className="flex items-center gap-2">
                      <Coffee 
                        className="w-5 h-5 transition-transform duration-500 group-hover:animate-bounce" 
                      />
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              <p className="text-center sm:text-left text-small text-default-500">
              ...
              <div className="flex items-center gap-1 text-small text-default-500">
                Made with <Heart size={14} className="text-danger" fill="currentColor" /> by WebToolsCenter Team
              </div>
            </div>
          </div>
        </div>
