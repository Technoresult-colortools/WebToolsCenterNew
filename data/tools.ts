...
export const allTools: Tool[] = [
  ...
  */
  ...
  },
  {
    ...
    icon: faBrush,
    description: "Create beautiful CSS background patterns with our interactive generator.",
  ...
  },
  {
    ...
    icon: faCode,
    description: 'Encode or decode URLs, Professional URL processing with RFC 3986 compliance and deep analysis',
