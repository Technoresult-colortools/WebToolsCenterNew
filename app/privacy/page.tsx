...
import { Card, CardBody, Link, Button, Accordion, AccordionItem } from "@nextui-org/react"
...
export default function PrivacyPolicyPage() {
  ...
  const sections = [
    { key: "interpretation", title: "Interpretation and Definitions" },
    { key: "collecting", title: "Collecting and Using Your Personal Data" },
    { key: "retention", title: "Retention of Your Personal Data" },
    { key: "transfer", title: "Transfer of Your Personal Data" },
    { key: "delete", title: "Delete Your Personal Data" },
    { key: "disclosure", title: "Disclosure of Your Personal Data" },
    { key: "security", title: "Security of Your Personal Data" },
    { key: "childrens-privacy", title: "Children's Privacy" },
    { key: "links", title: "Links to Other Websites" },
    { key: "changes", title: "Changes to this Privacy Policy" },
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <section className="pt-16 pb-8 px-4 relative overflow-hidden">
        ...
        >
          ...
          <div className="flex justify-center items-center">
            ...
            <span className="text-default-600">Last updated: January 24, 2025</span>
          </div>
        </div>
      </section>
      ...
      <main className="flex-grow container mx-auto px-4 py-8 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          {/* Table of Contents */}
          <Card className="lg:col-span-1 bg-content2/50 backdrop-blur-sm h-fit sticky top-20">
          ...
          <Card className="lg:col-span-3 bg-content2/50 backdrop-blur-sm">
            <CardBody className="p-8">
              ...
              <Accordion
                ...
                onSelectionChange={(keys) => handleAccordionChange(Array.from(keys) as string[])}
              >
                {sections.map((section) => (
                  <AccordionItem key={section.key} aria-label={section.title} title={section.title} id={section.key}>
                    {section.key === "interpretation" && (
                      <>
                        ...
                        <p className="text-default-600 mb-4">For the purposes of this Privacy Policy:</p>
                        <ul className="list-disc pl-6 space-y-2 text-default-600">
                          ...
                          <li>
                            ...
                            Agreement) refers to WebToolsCenter.
                          </li>
                          <li>
                          ...
                          <li>
                            ...
                            <Link href="https://webtoolscenter.com/" isExternal className="text-primary">
                    ...
                    {section.key === "collecting" && (
                      <>
                        ...
                        <p className="text-default-600 mt-4 mb-4">
                        ...
                        <h4 className="text-md font-semibold mt-4 mb-2">Tracking Technologies and Cookies</h4>
                        <p className="text-default-600 mb-4">
                        ...
                        <ul className="list-disc pl-6 space-y-4 text-default-600">
                          <li>
                        ...
                        <h3 className="text-lg font-semibold mt-6 mb-2">Use of Your Personal Data</h3>
                        <p className="text-default-600 mb-4">
                    ...
                    {section.key === "disclosure" && (
                      <>
                        ...
                        <h4 className="text-md font-semibold mt-4 mb-2">Law enforcement</h4>
                        <p className="text-default-600 mb-4">
                          Under certain circumstances, the Company may be required to disclose Your Personal Data if
                          required to do so by law or in response to valid requests by public authorities (e.g. a court
                          or a government agency).
                        </p>
                        <h4 className="text-md font-semibold mt-4 mb-2">Other legal requirements</h4>
                        <p className="text-default-600 mb-4">
                      ...
                      <>
                        ...
                        <ul className="list-disc pl-6 space-y-2 text-default-600">
                          <li>
                            ...
                            <Link href="https://webtoolscenter.com/contact" isExternal className="text-primary">
                              https://webtoolscenter.com/contact
                            </Link>
                          </li>
                        </ul>
                      </>
      ...
      {/* CTA Section */}
      <section className="py-12 px-4 bg-content3">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
            Have questions about our Privacy Policy?
          </h2>
          <p className="text-default-600 mb-6">
            We're here to help. Reach out to our team for any clarifications or concerns.
          </p>
          <Button as={Link} href="/contact" color="primary" endContent={<ChevronRight className="ml-2" />}>
            Contact Us
          </Button>
        </div>
      </section>
