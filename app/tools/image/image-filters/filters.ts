...
export const AllFilters: Filter[] = [
  ...
  { name: "Hue Rotate", cssFilter: "hue-rotate", intensity: 360, unit: "deg", defaultIntensity: 180, category: "basic" },
  ...
  { name: "Drop Shadow", cssFilter: "drop-shadow", intensity: 20, unit: "px", defaultIntensity: 5, category: "effects" },
  { name: "Vintage", cssFilter: "custom", intensity: 100, unit: "%", defaultIntensity: 100, category: "effects", 
      description: "A warm, nostalgic filter with sepia tones" },
  { name: "Cold", cssFilter: "custom", intensity: 100, unit: "%", defaultIntensity: 100, category: "effects",
      description: "A cool blue tone filter" },
  { name: "Warm", cssFilter: "custom", intensity: 100, unit: "%", defaultIntensity: 100, category: "effects",
      description: "A warm, golden tone filter" },
  { name: "Sunset", cssFilter: "custom", intensity: 100, unit: "%", defaultIntensity: 100, category: "artistic",
      description: "Orange and pink tones reminiscent of sunset" },
  { name: "Film", cssFilter: "custom", intensity: 100, unit: "%", defaultIntensity: 100, category: "artistic",
      description: "Classic film look with subtle contrast and saturation" },
  { name: "Duotone", cssFilter: "custom", intensity: 100, unit: "%", defaultIntensity: 100, category: "artistic",
      description: "Two-tone color effect for dramatic images" },
  { name: "Dramatic", cssFilter: "custom", intensity: 100, unit: "%", defaultIntensity: 100, category: "artistic",
      description: "High contrast, deep shadows for dramatic effect" },
  { name: "Noir", cssFilter: "custom", intensity: 100, unit: "%", defaultIntensity: 100, category: "artistic",
      description: "Black and white with high contrast for film noir effect" },
  { name: "Polaroid", cssFilter: "custom", intensity: 100, unit: "%", defaultIntensity: 100, category: "artistic",
      description: "Soft, slightly faded look similar to polaroid photos" },
  { name: "Vignette", cssFilter: "custom", intensity: 100, unit: "%", defaultIntensity: 100, category: "effects",
      description: "Darkened edges to focus attention on the center" },
  { name: "Retrowave", cssFilter: "custom", intensity: 100, unit: "%", defaultIntensity: 100, category: "artistic",
      description: "Vibrant pink and blue tones inspired by 80s aesthetics" },
  { name: "Pop Art", cssFilter: "custom", intensity: 100, unit: "%", defaultIntensity: 100, category: "artistic",
      description: "Bright, high-contrast colors in pop art style" }
];

// Create filter categories object
export const filterCategories: {[key: string]: Filter[]} = AllFilters.reduce((acc, filter) => {
