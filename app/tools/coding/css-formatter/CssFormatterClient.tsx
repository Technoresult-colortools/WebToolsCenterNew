    ...
    <div className="flex flex-col gap-8">
      ...
      <Card className="mt-8 bg-default-50 dark:bg-default-100 p-4 md:p-8">
            ...
            <ul className="list-disc list-inside space-y-2 text-sm md:text-base">
                ...
                <li>Integrate the formatting process into your **build pipeline** for consistent styling.</li>
                <li>Experiment with different property sorting algorithms for better organization.</li>
                <li>Use the **character count** feature to optimize performance by identifying verbose selectors or rules.</li>
            </ul>
            </div>
