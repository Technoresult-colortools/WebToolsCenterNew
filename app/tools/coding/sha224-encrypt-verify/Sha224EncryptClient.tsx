...
export default function SHA224EncryptVerify() {
  ...
  return (
    <ToolLayout
      ...
      toolId="678f382f26f06f912191bcc4"
    >
     ...
     <div className="flex flex-col gap-8">   
      ...
      <Card className="bg-default-50 dark:bg-default-100">
        <CardBody className="p-6">
          <Tabs aria-label="SHA-224 options">
            <Tab key="generate" title="Generate SHA-224">
              <div className="space-y-4 mt-4">
                <Textarea
                  ...
                  minRows={4}
                />
                <Input label="SHA-224 Hash" variant="bordered" value={output} readOnly />
              </div>
            </Tab>
            <Tab key="verify" title="Verify SHA-224">
              <div className="space-y-4 mt-4">
                <Textarea
                  label="Input Text"
                  ...
                  minRows={4}
                />
                <Input label="Generated SHA-224 Hash" variant="bordered" value={output} readOnly />
                <Input
          ...
          <div className="mt-4 flex flex-col md:flex-row gap-2 w-full">
            <Button className="w-full md:flex-1" color="primary" onPress={generateSHA224} startContent={<Hash />}>
              Generate SHA-224
            </Button>
        ...
        <CardBody>
          <div className="rounded-xl p-2 md:p-4 max-w-4xl mx-auto">
            ...
            <ol className="list-decimal list-inside space-y-2 text-sm md:text-base">
              ...
              <li>Generate the SHA-224 hash</li>
            ...
            <ul className="list-disc list-inside space-y-2 text-sm md:text-base">
              <li>Generates 224-bit cryptographic hash values</li>
            ...
            <p className="text-sm md:text-base text-default-600 mb-4">
              While SHA-224 offers robust security, it is important to implement additional cryptographic techniques such as salting 
              and multiple iterations to enhance security. It is recommended for general hashing applications but may not be ideal 
              for password storage without key-stretching techniques like PBKDF2 or bcrypt.
            </p>
            ...
            <ul className="list-disc list-inside space-y-2 text-sm md:text-base">
              ...
              <li>Not ideal for password storage without additional security layers</li>
              <li>Shorter hash length compared to SHA-256 or SHA-512</li>
            </ul>
            ...
            <ul className="list-disc list-inside space-y-2 text-sm md:text-base">
              ...
              <li>Cryptographic security applications in various industries</li>
            </ul>
            ...
            <p className="text-sm md:text-base text-default-600">
              The SHA-224 Hash Generator & Verifier is an essential tool for cryptographic security and data integrity verification. 
              By leveraging its capabilities alongside best practices like salting and multiple iterations, users can generate and 
              verify hashes effectively. Whether used for file verification, digital signatures, or security applications, SHA-224 
              remains a reliable and efficient hashing algorithm.
            </p>
          </div>
        </CardBody>
      </Card>
