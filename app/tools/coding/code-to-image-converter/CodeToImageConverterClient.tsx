    ...
    >
                ...
                {backgroundOptions.gradients.map((gradient) => (
                  <button
                    ...
                    className={`h-12 rounded-md transition-all hover:scale-105 ${
                      selectedBackground === gradient.value ? "ring-2 ring-primary shadow-md" : "ring-1 ring-border"
                    }`}
                    style={{
     ...
     {/* Combined Settings Card */}
      ...
      <div className="rounded-xl p-2 md:p-4 max-w-4xl mx-auto">
        ...
        <div className="my-8">
          <NextImage
            src="/Images/InfosectionImages/WebToolsCenter-example.png?height=400&width=600"
            alt="Screenshot of the Code to Image Converter interface showing code input, styling options, and the generated image preview"
            width={600}
            height={400}
        ...
        <ol className="list-decimal list-inside space-y-2 text-sm md:text-base">
          <li>Enter or paste your code in the editor area.</li>
          <li>Select a programming language from the dropdown menu for proper syntax highlighting.</li>
          <li>Choose a code theme that matches your preference or branding.</li>
          <li>Customize the filename displayed in the window controls.</li>
          <li>Adjust the background using gradients, solid colors, or custom images.</li>
          <li>Fine-tune appearance settings like font, padding, and shadow.</li>
          <li>Toggle line numbers and window controls as needed.</li>
          <li>Add an optional watermark with your brand or website.</li>
          <li>Use the <strong>"Copy to Clipboard"</strong> button to copy the image for immediate sharing.</li>
          <li>Use the <strong>"Download"</strong> button to save the image in your preferred format.</li>
        </ol>
        ...
        <ul className="list-disc list-inside space-y-2 text-sm md:text-base">
          <li><strong>Shiki-powered syntax highlighting</strong> for accurate code representation.</li>
          <li>Support for <strong>40+ programming languages</strong> including JavaScript, Python, HTML, CSS, and more.</li>
          <li><strong>16+ beautiful themes</strong> including popular options like GitHub Dark, Dracula, and Night Owl.</li>
          <li><strong>Customizable backgrounds</strong> with gradients, solid colors, and image uploads.</li>
          <li><strong>Random background images</strong> from Unsplash with programming-related content.</li>
          <li><strong>12 coding fonts</strong> optimized for readability and aesthetics.</li>
          <li>Adjustable <strong>font size, tab size, and padding</strong> for perfect presentation.</li>
          <li><strong>Window controls</strong> with automatic file icon detection based on language.</li>
          <li><strong>Customizable shadows</strong> to enhance visual appeal.</li>
          <li><strong>Watermarking options</strong> with text, icons, and positioning control.</li>
          <li><strong>Multiple export formats</strong> including PNG, JPEG, and WebP.</li>
          <li><strong>Adjustable image quality</strong> for balancing file size and resolution.</li>
          <li><strong>Fullscreen preview mode</strong> for examining details before export.</li>
          <li><strong>Responsive design</strong> that works on desktop and mobile devices.</li>
        </ul>
        ...
        <ul className="list-disc list-inside space-y-2 text-sm md:text-base">
          <li>Create <strong>consistent branding</strong> by using your company colors as background and adding your logo as a watermark.</li>
          <li>Generate <strong>high-resolution images</strong> using the Ultra quality setting for presentations and documentation.</li>
          <li>Use the tool to create <strong>code snippets for tutorials</strong> with consistent styling across all examples.</li>
          <li>Combine with <strong>screenshot tools</strong> to create comprehensive technical documentation.</li>
          <li>Create a <strong>library of code examples</strong> with consistent styling for educational content.</li>
          <li>Use the <strong>custom background</strong> feature to place code on relevant contextual images for more engaging social media posts.</li>
          <li>Leverage the <strong>watermark feature</strong> to build brand recognition when sharing code snippets online.</li>
          <li>Use different themes to <strong>highlight different parts of your codebase</strong> in documentation (e.g., server code vs. client code).</li>
        </ul>
      </div>
    </Card>
