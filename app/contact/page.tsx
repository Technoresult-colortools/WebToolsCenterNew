            ...
            <CardBody className="p-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center p-3 rounded-lg bg-blue-700 text-white hover:bg-blue-800 transition-colors col-span-2"
                >
                  <FontAwesomeIcon icon={faLinkedinIn} className="w-6 h-6 mr-3" />
                  <span>LinkedIn</span>
                </Link>
              </div>
            </CardBody>
